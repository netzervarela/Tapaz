...
function addRow(ArrayData, tableID, counter) {
    ...
    var newRow = $(tableID).dataTable().fnAddData([
        ...
        (ArrayData['CitaHoraClienteIniciaAtencion'] != '' ? moment(ArrayData['CitaHoraClienteIniciaAtencion'], 'HH:mm:ss').format("hh:mm a") : 'No definido'),
        (ArrayData['CitaHoraClienteSaleAtencion'] != '' ? moment(ArrayData['CitaHoraClienteSaleAtencion'], 'HH:mm:ss').format("hh:mm a") : 'No definido'),
